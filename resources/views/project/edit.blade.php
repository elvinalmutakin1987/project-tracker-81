                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select @error('proj_customer') is-invalid @enderror"
                                            id="customer_id" name="customer_id" required>
                                            @foreach ($customer as $d)
                                                <option value="{{ $d->id }}"
                                                    {{ old('customer_id') == $d->id || $project->customer_id == $d->id ? 'selected' : '' }}>
                                                    {{ $d->cust_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('customer_id')
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="proj_phone"
                                            value="{{ old('proj_phone') ?? $project->proj_phone }}">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="proj_email"
                                            value="{{ old('proj_email') ?? $project->proj_email }}">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('proj_pic') is-invalid @enderror"
                                            name="proj_pic" required value="{{ old('proj_pic') ?? $project->proj_pic }}">
                                        @error('proj_pic')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_denah"
                                                name="proj_denah" {{ $project->proj_denah == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_shop"
                                                name="proj_shop" {{ $project->proj_shop == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_sld"
                                                name="proj_sld" {{ $project->proj_sld == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_rab"
                                                name="proj_rab" {{ $project->proj_rab == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_personil"
                                                name="proj_personil" {{ $project->proj_personil == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="proj_schedule"
                                                name="proj_schedule" {{ $project->proj_schedule == 1 ? 'checked' : '' }}>
