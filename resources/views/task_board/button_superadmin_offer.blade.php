<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
    <div class="btn-group" role="group">
        ...
        <ul class="dropdown-menu">
            <li>
                <form class="d-inline"
                    action="{{ route('task_board.cancel', ['assignee' => 'sales-order', 'id' => $d->id, 'doc_type' => 'quotation']) }}"
            ...
            <li>
                <form class="d-inline"
                    action="{{ route('task_board.delete', ['assignee' => 'sales-order', 'id' => $d->id, 'doc_type' => 'quotation']) }}"
